...
(function (global) {
  ...
  var STOPWORDS = [
    ...
    // 30차: 실제 대화 상위 단어를 채우던 말버릇, 호칭, 봇과 시스템 단어(활동 통계 화면도 같은 목록으로 거른다)
    "샵검색", "톡게시판", "성공", "단어", "맞히기", "정답", "힌트",
  ...
  var KW_CATEGORIES = {
    "나들이": [
      "산책", "걷기", "만보", "나들이", "소풍", "피크닉", "한강", "공원", "천변", "둘레길",
      "영화", "영화관", "극장", "전시", "전시회", "미술관", "갤러리", "박물관",
      "공연", "연극", "뮤지컬", "콘서트", "페스티벌", "축제", "재즈", "버스킹",
      "등산", "트레킹", "산행", "여행", "드라이브", "당일치기", "구경", "관람",
      "벚꽃", "단풍", "야경", "데이트코스", "볼거리", "나들잇길"
    ],
    "맛집": [
