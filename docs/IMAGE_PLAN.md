...
**진행 상태(2026-09-21)**: 16장 중 13장 도착·적용. 안내·맛집 배너, 소식 스팟, 오늘 뭐 먹지, 소식·맛집 빈 상태, 오프라인이 화면에 붙었고, 홈 계절 6장은 웹용 파일까지 만들어 두었습니다(가을 유지, 교체는 수동). 통계 스팟·정산 스팟·통계 빈 상태 3장은 자리만 붙어 있고 파일이 오면 열립니다(공유 미리보기 통계·정산도 그때). 적용 규격은 `IMAGE_SPEC.md` 4~8절. 실제 생성된 정사각형은 1024 가 아니라 1254 × 1254 였고 그대로 줄여 썼습니다.
